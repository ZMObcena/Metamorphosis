...
public class EventNames {
	...
	public class Jam1_Event
	{
		public const string ON_START = "ON_START";
		public const string ON_EXIT = "ON_EXIT";
		public const string ON_RESTART = "ON_RESTART";

		public const string ON_ADD_POINTS = "ON_ADD_POINTS";
		public const string ON_UPDATE_POINTS = "ON_UPDATE_POINTS";
		public const string ON_RESET_POINTS = "ON_RESET_POINTS";
		public const string ON_UPDATE_TIME = "ON_UPDATE_TIME";
		...
		public const string ON_SPAWN_PLATFORM = "ON_SPAWN_PLATFORM";

		public const string ON_PLAYER_JUMP = "ON_PLAYER_JUMP";
		public const string ON_PLAYER_FALL = "ON_PLAYER_FALL";
	}
}
